...
torch for model building, transformers for pre-trained models,
scikit-learn for data splitting.
Dataset:Yelp reviews dataset is loaded using kagglehub.
Balance Data:The dataset is balanced by sampling 100 reviews for each star rating to ensure the model doesn't get biased.
Dataset Preparation:
